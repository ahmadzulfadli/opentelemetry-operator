...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoInjectionSpec) DeepCopyInto(out *AutoInjectionSpec) {
	*out = *in
	if in.TargetServices != nil {
		in, out := &in.TargetServices, &out.TargetServices
		*out = make([]TargetService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoInjectionSpec.
func (in *AutoInjectionSpec) DeepCopy() *AutoInjectionSpec {
	if in == nil {
		return nil
	}
	out := new(AutoInjectionSpec)
	in.DeepCopyInto(out)
	return out
}
